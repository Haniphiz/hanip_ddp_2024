print('''Print semua bilangan ganjil dari list berikut, hentikan perulangan ketika sudah melewati bilangan 553. Pakai perulangan while. 
      jawab =''')
...
# menggunakan loop while untuk mencetak bilangan ganjil sampai bertemu dengan 533

while index < len(numbers):
    if numbers[index] % 2 != 0: # cetak apakah bilangan ganjil 
        print(numbers[index], end= " ")
    if numbers[index] == 553: # hentikan perulangan jika 553
        break
    index += 1
print("")
...
''')
jumlah_bintang = int(input("Masukkan jumlah bintang: "))
